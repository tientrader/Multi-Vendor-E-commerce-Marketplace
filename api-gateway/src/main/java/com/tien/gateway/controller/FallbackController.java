...
public class FallbackController {
      ...
      public ResponseEntity<String> shopServiceFallback() {
            return new ResponseEntity<>("Shop Service is currently unavailable. Please try again later.", HttpStatus.SERVICE_UNAVAILABLE);
      }
      ...
      public ResponseEntity<String> cartServiceFallback() {
            return new ResponseEntity<>("Cart Service is currently unavailable. Please try again later.", HttpStatus.SERVICE_UNAVAILABLE);
      }
      ...
      public ResponseEntity<String> postServiceFallback() {
            return new ResponseEntity<>("Post Service is currently unavailable. Please try again later.", HttpStatus.SERVICE_UNAVAILABLE);
      }

      @RequestMapping("/fallback/notification")
      public ResponseEntity<String> notificationServiceFallback() {
            return new ResponseEntity<>("Notification Service is currently unavailable. Please try again later.", HttpStatus.SERVICE_UNAVAILABLE);
      }
