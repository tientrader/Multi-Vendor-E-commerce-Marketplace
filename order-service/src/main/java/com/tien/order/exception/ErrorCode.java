...
public enum ErrorCode {
      ...
      ORDER_NOT_FOUND(1014, "ORDER_NOT_FOUND", HttpStatus.NOT_FOUND),
      ...
      VARIANT_ID_IS_REQUIRED(1025, "VARIANT_ID_IS_REQUIRED", HttpStatus.BAD_REQUEST),
      PAYMENT_FAIL(1026, "PAYMENT_FAIL", HttpStatus.BAD_REQUEST),
      EXTERNAL_SERVICE_ERROR(1027, "EXTERNAL_SERVICE_ERROR", HttpStatus.INTERNAL_SERVER_ERROR),
      DATA_INTEGRITY_VIOLATION(1028, "DATA_INTEGRITY_VIOLATION", HttpStatus.BAD_REQUEST),
      DUPLICATE_ENTRY(1029, "DUPLICATE_ENTRY", HttpStatus.BAD_REQUEST),
      FOREIGN_KEY_VIOLATION(1030, "FOREIGN_KEY_VIOLATION", HttpStatus.BAD_REQUEST),
      FILE_SIZE_EXCEEDED(1031, "FILE_SIZE_EXCEEDED", HttpStatus.BAD_REQUEST),
      MISSING_REQUIRED_PARAMETER(1032, "MISSING_REQUIRED_PARAMETER", HttpStatus.BAD_REQUEST),
      MORE_THAN_ONE_PRODUCT(1033, "MORE_THAN_ONE_PRODUCT", HttpStatus.BAD_REQUEST),
      ;
